      ...
      <CardContent className="p-6">
        ...
        {!isPremium ? (
          <>
            ...
            <Link href="/pricing"><Button variant="primary" size="sm">View Premium Plans</Button></Link>
          </>
        ) : !hasAnalysis ? (
          <>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
            ...
            <Link href="/candidate/career-coach"><Button variant="primary" size="sm">Run Career Coach Analysis</Button></Link>
          </>
        ) : (
          <>
