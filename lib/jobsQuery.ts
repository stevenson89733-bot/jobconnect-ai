...
export const JOB_SELECT_FIELDS =
  'id, title, company_name, location, work_type, salary_label, salary_min, salary_max, job_type, category, tags, description, is_featured, cross_border_status, cross_border_signals, cross_border_confidence, created_at, apply_url, source, geo_analysis, company:companies(logo_url)'
